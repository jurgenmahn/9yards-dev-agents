...
```bash
git add script.php composer.json README.md
```
...
Refactor: extract database logic to separate class
...
If validation found issues, DO NOT commit yet - return to backend/database agents to fix issues first.
