---
description: Test and validate PHP implementations
capabilities:
  [
    "testing",
    "validation",
...
```bash
php script.php --input test_data.csv --output results/
```
...
- Error message unclear: "Undefined index: 'name'"
